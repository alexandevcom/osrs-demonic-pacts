...
export const LEAGUE_INFO = {
  ...
  startingRegion: "Varlamore",
  spawnLocation: "Yama's Lair (exit to Civitas illa Fortis)",
  forcedSecondRegion: "Karamja",
  misthalinAccessible: false,
  generalAccess: ["Abyss", "Zanaris"],
  startingBoosts: { herblore: 3, runecraft: 5 },
  freeItems: ["Dramen staff", "Spade", "Impling jar", "Strange device x2"],
  autoCompletedQuests: [
    "Dragon Slayer I",
    "Learning the Ropes",
    "The Restless Ghost",
  ...
  passiveEffects: [
    "Farming ticks every minute instead of every five minutes",
    "Run energy never drains",
    "Clue scrolls drop as stackable scroll boxes",
    "Clue-step progress saved between clues",
  ],
...
export const AREAS = [
  {
    ...
    name: "Varlamore",
    locked: true,
    description: "Starting area. Home of the Fortis Colosseum, Cam Torum, Hunter Guild, and Yama's Lair.",
    image: img("img/areas/varlamore.png"),
    highlights: ["Fortis Colosseum", "Cam Torum", "Hunter Guild", "Yama's Lair", "Mastering Mixology", "Sunfire Runecrafting"],
  },
  {
    id: "karamja",
    name: "Karamja",
...
export const RELICS = [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "natures-accord", name: "Nature's Accord", description: "Farming enhancement with boosted crop yields and world connectivity through spirit tree/fairy ring network.", image: img("img/relics/natures-accord.png") },
